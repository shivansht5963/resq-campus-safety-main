      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-4">
            <a 
              href="https://github.com/shivansht5963" 
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-card border-3 border-border rounded-full flex items-center justify-center hover:translate-y-[-2px] transition-all card-shadow"
              aria-label="GitHub"
            >
            ...
            <a 
              href="https://www.linkedin.com/in/shivansh-tiwari-8059a8292/" 
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-card border-3 border-border rounded-full flex items-center justify-center hover:translate-y-[-2px] transition-all card-shadow"
              aria-label="LinkedIn"
            ...
            <a 
              href="mailto:shivanshtiwari6849@gmail.com" 
              className="w-10 h-10 bg-card border-3 border-border rounded-full flex items-center justify-center hover:translate-y-[-2px] transition-all card-shadow"
              aria-label="Email"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
